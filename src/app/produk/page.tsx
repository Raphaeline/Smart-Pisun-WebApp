			...
			<ul>
				...
				<li>
					<a className="flex px-[28px] py-[14px] 2xl:py-[20px]" href="/admin">
						...
						<p className={isAdminPage ? "text-[#25B6D0] font-poppins text-[16px] 2xl:text-[20px] px-[6px]" : "text-[#000000] font-poppins text-[16px] 2xl:text-[20px] px-[6px]"}>Admin</p>
					</a>
				</li>
				<li>
	...
	return (
		<main className="min-h-screen flex-col items-center p-24 bg-[#f4f9fb]">
			...
			<div className="fixed right-10 top-10">
				<a
					href="/produk/tambahProduk"
					className="bg-[#25B6D0] hover:bg-[#64abba] py-[9px] 2xl:py-[12px] px-[22px] 2xl:px-[30px] rounded-md font-poppins text-[14px] 2xl:text-[16px] drop-shadow hover:drop-shadow-md hover:shadow-lg ml-4"
				>
					Tambah Produk
				</a>
			</div>
			...
			<div className="fixed right-10">
				<select
					...
					className="font-poppins text-[15px] text-[#243956] w-[135px] 2xl:w-[165px] h-[32px] 2xl:h-[48px]  pl-10 rounded border border-[#D4E3E8]"
				>
					...
					<tbody>
						{currentItems.map((produk) => (
							<tr className="bg-white" key={produk.id}>
								...
								<td className="border-y border-y-[#E0E0E0] text-black py-[15px] px-[30px] font-poppins text-[12px] 2xl:text-[16px] w-[150px] max-w-[150px] 2xl:w-[225px] 2xl:max-w-[225px] text-center">
									Rp {produk.Harga},00
								</td>
			...
			<div className="pagination b-10 flex justify-center">
				<button
					className="bg-[#55A3BD] hover:bg-[#5495a2] py-[9px] 2xl:py-[12px] px-[22px] 2xl:px-[30px] rounded-md font-poppins text-[14px] 2xl:text-[16px] drop-shadow hover:drop-shadow-md shadow-md mr-4"
